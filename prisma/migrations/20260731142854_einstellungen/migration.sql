...
INSERT INTO "new_Vorgang" ("archiviert", "beraterId", "buchungsweg", "erstelltAm", "id", "kanal", "kundeId", "status", "updatedAt", "verlustgrund", "wiedervorlage") SELECT "archiviert", "beraterId", "buchungsweg", "erstelltAm", "id", "kanal", "kundeId", "status", "updatedAt", "verlustgrund", "wiedervorlage" FROM "Vorgang";
DROP TABLE "Vorgang";
