...
import StartseiteFilter from "@/components/StartseiteFilter";
...
export default async function UebersichtPage() {
  ...
  return (
    <main className="p-6 md:p-8 max-w-2xl mx-auto flex flex-col gap-5">
      ...
      <StartseiteFilter
        poolEintraege={poolEintraege}
        normaleEintraege={normaleEintraege}
        anwesendeMitarbeiter={anwesendeMitarbeiter}
